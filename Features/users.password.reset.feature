Feature: User reset password
  Background:
    Given the following data in "public.t_user_usr" exist:
      ...
      | TestUser       | TestUser      | TestUser     | testuser               | testuser@canaltp.fr | testuser@canaltp.fr | ik5mmzc7ia04o44kowokkw8gkc8coc8 | eV/AToo3NOL9S3HzWC67EE2ZKDn2OLZMKQ4cTPBLx+/H88G7oho5OWMsrj9hiNR4VOy19ryYJaHoZahw9m7doQ== | TRUE        | FALSE      | FALSE       | MeRhd4K1QZyh_TuuP8M6ft4xRU-p1A6KKZn0zUfPVSk | "2016-09-22 13:36:17"     | 0                       | 1      |  1         |
